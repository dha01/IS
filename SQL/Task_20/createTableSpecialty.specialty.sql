...
create table Specialty.specialty_detail 
(
	...
	constraint FK__specialty_detail__qualification foreign key (qualification) references Specialty.qualification,
...
-- Добавление записи в таблицу "Specialty_detail"
	insert into Specialty.specialty_detail(actual_date,specialty,semestr_count,training_period,qualification,form_study,pay_space,lowcost_space)
